...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
function [z, H] = getRealMeasurement(pos, landmark_pos, observation_variance)
...
%   landmark_angle = landmark_angle + normrnd(0, observation_variance(2)*.25);
  ...
  landmark_angle=landmark_pos(1);
  landmark_distance=landmark_pos(2);

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
function [z, Hx, Hm] = getMeasurement2(pos, landmark_pos, observation_variance)
...
%   in an extended Kalman filter.
  ...
  Hx = [-(landmark_pos(1) - pos(1))/sqrt(q), -(landmark_pos(2) - pos(2))/sqrt(q), 0.0;
        (landmark_pos(2) - pos(2))/q,       -(landmark_pos(1) - pos(1))/q,      -1.0;
        0.0,                                0.0,                               1.0]; %Jacobian wrt to vehicle states
    
   Hm = [ (landmark_pos(1) - pos(1))/sqrt(q),   (landmark_pos(2) - pos(2))/sqrt(q); % Jacobian wrt feature states
